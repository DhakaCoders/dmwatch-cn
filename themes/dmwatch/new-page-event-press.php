...
<section class="page-banner page-bnr-rgt-con page-bnr-event-pp-report" style="overflow: hidden;">
  <div class="page-banner-controller">
    <div class="page-banner-bg" style="background-image:url(assets/images/page-bnr-event-pp-report.jpg);">
    </div>
                ...
                <ul class="clearfix reset-list">
                  <li>
                    <div class="event-pp-report-page-tab-1-grd">
                      <div class="epprpt-grd-fea-img">
                        ...
                        <div class="inline-bg" style="background: url(assets/images/epprpt-grd-fea-img-01.jpg);"></div>
                      </div>
                  ...
                  <li>
                    <div class="event-pp-report-page-tab-1-grd">
                      <div class="epprpt-grd-fea-img">
                        <a href="#" class="overlay-link"></a>
                        <div class="inline-bg" style="background: url(assets/images/epprpt-grd-fea-img-02.jpg);"></div>
                      </div>
                      <div class="mhc epprpt-grd-des">
                        <span>JUNE  27, 2020</span>
                        <h4 class="epprpt-grd-des-title"><a href="#">Lorem Ipsum</a></h4>
                  ...
                  <li>
                    <div class="event-pp-report-page-tab-1-grd">
                      <div class="epprpt-grd-fea-img">
                        <a href="#" class="overlay-link"></a>
                        <div class="inline-bg" style="background: url(assets/images/epprpt-grd-fea-img-03.jpg);"></div>
                      </div>
                      <div class="mhc epprpt-grd-des">
                        <span>JUNE  27, 2020</span>
                        <h4 class="epprpt-grd-des-title"><a href="#">Lorem Ipsum</a></h4>
                  ...
                  <li>
                    <div class="event-pp-report-page-tab-2-grd">
                      <div class="epprpt2-grd-fea-img">
                        ...
                        <div class="inline-bg" style="background: url(assets/images/epprpt2-grd-fea-img-01.jpg);">
                          <a href="#" class="overlay-link"></a>
                        </div>
                      </div>
                  ...
                  <li>
                    <div class="event-pp-report-page-tab-2-grd">
                      <div class="epprpt2-grd-fea-img">
                        ...
                        <div class="inline-bg" style="background: url(assets/images/epprpt2-grd-fea-img-02.jpg);">
                          <a href="#" class="overlay-link"></a>
                        </div>
                      </div>
                      <div class="epprpt2-grd-des">
                  ...
                  <li>
                    <div class="event-pp-report-page-tab-2-grd">
                      <div class="epprpt2-grd-fea-img">
                        ...
                        <div class="inline-bg" style="background: url(assets/images/epprpt2-grd-fea-img-03.jpg);">
                          <a href="#" class="overlay-link"></a>
                        </div>
                      </div>
                      <div class="epprpt2-grd-des">
